// components/lab/VisionScene.css.ts
// LAB SKETCH — the Vision: glass project frames floating over the Florence
// vista. Throwaway styles.
...
export const hint = style({
  ...
  fontSize: '0.75rem',
  color: '#FFF8EC',
  textShadow: '0 1px 8px rgba(56, 44, 25, 0.5)',
})
